 ...
 * action manager资源的描述
 *
 * @class qc.ActionManagerAsset
 * @constructor
 * @internal
 */
var ActionManagerAsset = qc.ActionManagerAsset = function(key, url, data, meta) {
    /**
...
ActionManagerAsset.prototype.constructor = ActionManagerAsset;

Object.defineProperties(ActionManagerAsset.prototype, {
    /**
 ...
 * 当前是不是还有依赖的资源没有加载成功？
 */
ActionManagerAsset.prototype.hasUnloadedDependence = function(game) {
